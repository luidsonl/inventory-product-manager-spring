...
export const PackagingTransactionCard: React.FC<Props> = ({ transaction, onClick }) => (
            ...
            <div className="space-y-3">
                ...
                <div className="space-y-1">
                    <div className="text-sm text-slate-600 flex justify-between">
                        <span>Type:</span>
                        <span className={`font-medium px-2 py-0.5 rounded text-xs ${transaction.type === TransactionType.INVENTORY_IN ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'
                            }`}>
                            {transaction.type}
                        </span>
                    </div>
